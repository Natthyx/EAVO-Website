  ...
  return (
    ...
    <h1 className="text-4xl font-bold text-center">Our Mission</h1>
        <p className="text-center mt-2 px-4">
          The Empowering African Voices Organization (EAVO) is dedicated to supporting African women and children by advocating for their rights...
        </p>
        <div id='programs'>
        <h1 className="text-4xl font-bold text-center mt-8 py-4">Our Programs</h1>
