...
const UpcomingEvents = () => {
  return (
    <div className="p-8">
      <h1 className="w-full text-center font-bold text-3xl mt-5 mb-2 font-serif">Upcoming Events</h1>
      <div className="w-[93%] m-auto flex flex-col lg:flex-row justify-center gap-6 mt-8">
        ...
        <div className="w-full lg:w-1/2 flex flex-col bg-gray-200 rounded-2xl overflow-hidden">
          <img className="w-full h-64 object-cover" src={pic} alt="Main Event" />
        ...
        <div className="w-full lg:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col bg-gray-200 rounded-2xl overflow-hidden">
            <img className="w-full h-32 object-cover" src={event1} alt="Annual Fundraising" />
            <div className="p-4 flex flex-col justify-between flex-grow">
              <h3 className="text-xl font-bold mb-2">Annual Fundraising</h3>
              <p className="text-center">
                An evening of dinner, entertainment, and fundraising for our programs...
              </p>
              <div className="flex justify-between items-center mt-5">
          ...
          <div className="flex flex-col bg-gray-200 rounded-2xl overflow-hidden">
            <img className="w-full h-32 object-cover" src={event2} alt="Community Health Fair" />
            <div className="p-4 flex flex-col justify-between flex-grow">
          ...
          <div className="flex flex-col bg-gray-200 rounded-2xl overflow-hidden">
            <img className="w-full h-32 object-cover" src={event3} alt="Empowerment Workshops" />
            <div className="p-4 flex flex-col justify-between flex-grow">
          ...
          <div className="flex flex-col bg-gray-200 rounded-2xl overflow-hidden">
            <img className="w-full h-32 object-cover" src={event4} alt="Youth Empowerment Summit" />
            <div className="p-4 flex flex-col justify-between flex-grow">
              <h3 className="text-xl font-bold mb-2">Youth Empowerment Summit</h3>
              <p className="text-center">
                A summit for young leaders to discuss and address issues facing youth in Africa...
              </p>
              <div className="flex justify-between items-center mt-5">
